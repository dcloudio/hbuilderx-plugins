...
declare const api_recordTestProcessDetails: (data: any) => Promise<void>;
...
export { api_recordTestRun, api_recordTestRunDetails, api_recordTestProcessDetails, api_executeStatisticAnalysis, api_updateTaskForMongoDB, api_getTaskDetails };
